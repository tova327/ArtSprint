          ...
          >
            <Flex gap={8} wrap={false} style={{ width: "max-content", paddingBottom: 4 }}>
              {paintings.map((painting, index) => (
                <Splitter style={{width:240, padding: 15, boxShadow: themeToken.components?.Card?.boxShadow , flex: "0 0 auto", borderRadius: themeToken.components?.Card?.borderRadiusLG }} key={painting.id}>
